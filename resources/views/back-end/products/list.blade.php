							...
							<table class="table table-hover">
								...
								<tbody>
									@foreach($data as $row)
										<tr>
											<td>{!!$row->id!!}</td>
											<td> <img src="{!!url('uploads/products/'.$row->images)!!}" alt="" width="50" height="40"></td>
											<td>{!!$row->name!!}</td>
											<td>{!!$row->intro!!}</td>
											...
											<td>
											    <a href="{!!url('admin/sanpham/giaynam/edit/'.$row->id)!!}" title="Sửa"><span class="glyphicon glyphicon-edit">edit</span> </a>
